...
// occupation, and suitable values for both items. Your function should log 
// a greeting to the console that uses the person's full name, and mentions 
// the person's title and occupation.

function greetings(arr, obj) {
  let fullName = arr.join(' ');
  let titleAndOccupation = Object.values(obj).join(' ');
  console.log(`Hello, ${fullName}! Nice to have a ${titleAndOccupation} around.`)
}
