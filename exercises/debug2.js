...
// If false is found, the function immediately returns true. If no occurrence of false has been found after iterating 
// through the entire array, the function returns false.

// Caroline's last method invocation of includesFalse (line 15) doesn't return what she expects. Why is that? Fix the 
...
function includesFalse(list) {
  for (let i = 0; i < list.length; i++) {
    ...
    if (element == false) { // needs strict equals === 
      return true;
    }
  }
